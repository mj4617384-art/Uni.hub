...
export default function Home() {
  ...
  const services = [
    { label: 'Errands', icon: Briefcase, action: () => showToast('Errands coming soon!') },
    { label: 'Marketplace', icon: ShoppingBag, action: () => showToast('Marketplace coming soon!') },
    { label: 'Wallet', icon: WalletIcon, action: () => showToast('Wallet coming soon!') },
    { label: 'Study Hub', icon: BookOpen, action: () => showToast('Study Hub coming soon!') },
    { label: 'Events', icon: CalendarDays, action: () => showToast('Campus Events coming soon!') },
    { label: 'Communities', icon: Users, action: () => showToast('Communities coming soon!') },
  ];
